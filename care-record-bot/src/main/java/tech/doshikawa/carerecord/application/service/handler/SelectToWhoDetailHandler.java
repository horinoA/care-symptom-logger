...
public class SelectToWhoDetailHandler implements PostbackActionHandler {
    ...
    public boolean supports(String action) {
        return "select_to_who_detail".equals(action);
    }

    @Override
    public Set<InputPhase> getAllowedPhases() {
        return Set.of(InputPhase.WAITING_FOR_TO_WHO_SUB);
    }
